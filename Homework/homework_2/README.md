...
<details>
  ...
  Problem kolegów z innego zespołu tkwił w błędnie podanych Label dla Service `api-svc`. W Label z nazwą `app.kubernetes.io/component` podali wartość `frontend` zamiast `api`.
